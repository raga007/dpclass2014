...
public class ReferenceLogProcessor {
  ...
  private void add(Record r) {
    ...
    if ( 0 == numAdds++ % 10000000 ) {
      System.out.println("numAdds = " + numAdds );
      //  System.out.println("numAdds, newestTime, tmp.getTime(), newestTime - tmp.getTime() " +
      //     numAdds + "," +
      //    newestTime + "," + tmp.getTime() + "," + (newestTime - tmp.getTime()));
    }
    while ( iter.hasNext() ) {
